...
router.get('/forgetPassword', csrfProtection, userController.getForgetPassword)
router.post('/forgetPassword', formParser, csrfProtection, emailValidationSchema, userController.forgetPassword)
router.get('/resetPassword', csrfProtection, userController.getResetPassword)
router.put('/resetPassword', formParser, csrfProtection, passwordValidationSchema, userController.resetPassword)
